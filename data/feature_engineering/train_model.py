...
def predict_match(home: str, away: str, models: dict,
    ...
    # star_reliance_gini: (a - h) sign is intentional — high gini = star-reliant = fragile,
    # so if the HOME team is more star-reliant, this term is negative (correct penalisation).
    squad_adv = (
        0.17 * np.tanh((h["first_xi_value"]       - a["first_xi_value"])      / 8e7)  # starting XI quality
